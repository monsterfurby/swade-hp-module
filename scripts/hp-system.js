...
class SWADEHPSystem {
    ...
    registerCustomSheet(CharacterSheetClass = null) {
        ...
        // Create the custom sheet class directly (no partial registration needed)
        console.log('SWADE HP Module: Creating custom sheet class with embedded HP template...');
